...
/**
 * Servlet implementation class SearchMovieRentalsByTypeController
 */
public class SearchMovieRentalsByTypeController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchMovieRentalsByTypeController() {
        super();
